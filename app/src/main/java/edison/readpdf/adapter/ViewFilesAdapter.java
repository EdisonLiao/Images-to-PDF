...
import edison.readpdf.interfaces.DataSetChanged;
import edison.readpdf.interfaces.EmptyStateChangeListener;
import edison.readpdf.interfaces.ItemSelectedListener;
import edison.readpdf.model.PDFFile;
import edison.readpdf.util.DialogUtils;
import edison.readpdf.util.DirectoryUtils;
import edison.readpdf.util.FileInfoUtils;
import edison.readpdf.util.FileSortUtils;
import edison.readpdf.util.FileUtils;
import edison.readpdf.util.PDFEncryptionUtility;
import edison.readpdf.util.PDFRotationUtils;
import edison.readpdf.util.PDFUtils;
import edison.readpdf.util.PopulateList;
import edison.readpdf.util.StringUtils;
import edison.readpdf.util.WatermarkUtils;

import static edison.readpdf.util.Constants.SORTING_INDEX;
import static edison.readpdf.util.FileInfoUtils.getFormattedDate;
...
public class ViewFilesAdapter extends RecyclerView.Adapter<ViewFilesAdapter.ViewFilesHolder>
    ...
    private void performOperation(int index, int position, File file) {
        switch (index) {
            case 0: //Open
                mFileUtils.openFile(mActivity,file.getPath(), FileUtils.FileType.e_PDF);
                break;
