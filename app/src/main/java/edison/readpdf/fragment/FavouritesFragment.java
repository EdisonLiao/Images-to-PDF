...
import edison.readpdf.activity.FavouritesActivity;
import edison.readpdf.activity.MainActivity;
import edison.readpdf.customviews.MyCardView;
...
import static edison.readpdf.util.Constants.ADD_IMAGES_KEY;
import static edison.readpdf.util.Constants.ADD_PASSWORD_KEY;
import static edison.readpdf.util.Constants.ADD_PWD;
import static edison.readpdf.util.Constants.ADD_TEXT_KEY;
import static edison.readpdf.util.Constants.ADD_WATERMARK;
import static edison.readpdf.util.Constants.ADD_WATERMARK_KEY;
import static edison.readpdf.util.Constants.BUNDLE_DATA;
import static edison.readpdf.util.Constants.COMPRESS_PDF;
import static edison.readpdf.util.Constants.COMPRESS_PDF_KEY;
import static edison.readpdf.util.Constants.EXCEL_TO_PDF_KEY;
import static edison.readpdf.util.Constants.EXTRACT_IMAGES;
import static edison.readpdf.util.Constants.EXTRACT_IMAGES_KEY;
import static edison.readpdf.util.Constants.EXTRACT_TEXT_KEY;
import static edison.readpdf.util.Constants.HISTORY_KEY;
import static edison.readpdf.util.Constants.IMAGE_TO_PDF_KEY;
import static edison.readpdf.util.Constants.INVERT_PDF_KEY;
import static edison.readpdf.util.Constants.MERGE_PDF_KEY;
import static edison.readpdf.util.Constants.PDF_TO_IMAGES;
import static edison.readpdf.util.Constants.PDF_TO_IMAGES_KEY;
import static edison.readpdf.util.Constants.QR_BARCODE_KEY;
import static edison.readpdf.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static edison.readpdf.util.Constants.REMOVE_PAGES;
import static edison.readpdf.util.Constants.REMOVE_PAGES_KEY;
import static edison.readpdf.util.Constants.REMOVE_PASSWORD_KEY;
import static edison.readpdf.util.Constants.REMOVE_PWd;
import static edison.readpdf.util.Constants.REORDER_PAGES;
import static edison.readpdf.util.Constants.REORDER_PAGES_KEY;
import static edison.readpdf.util.Constants.ROTATE_PAGES;
import static edison.readpdf.util.Constants.ROTATE_PAGES_KEY;
import static edison.readpdf.util.Constants.SPLIT_PDF_KEY;
import static edison.readpdf.util.Constants.TEXT_TO_PDF_KEY;
import static edison.readpdf.util.Constants.VIEW_FILES_KEY;
import static edison.readpdf.util.Constants.ZIP_TO_PDF_KEY;
