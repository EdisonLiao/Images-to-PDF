...
import edison.readpdf.adapter.HistoryAdapter;
import edison.readpdf.database.AppDatabase;
import edison.readpdf.database.History;
...
public class HistoryFragment extends Fragment implements HistoryAdapter.OnClickListener {
    ...
    public void onItemClick(String path) {
        ...
        if (file.exists()) {
            fileUtils.openFile(requireContext(),path, FileUtils.FileType.e_PDF);
        } else {
